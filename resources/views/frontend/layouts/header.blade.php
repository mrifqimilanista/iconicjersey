                        ...
                        <ul class="list-main">
                            ...
                            @auth 
                                ...
                                <li><i class="fa fa-truck"></i> <a href="{{route('order.track')}}">Track Order</a></li>
                                    ...
                                    <li><i class="ti-user"></i> <a href="{{route('admin')}}"  target="">Dashboard</a></li>
                                @else 
                                <li><i class="fa fa-truck"></i> <a href="{{route('order.track')}}">Track Order</a></li>

                                    <li><i class="ti-user"></i> <a href="{{route('user')}}"  target="">Dashboard</a></li>
                                @endif
                ...
                <div class="col-lg-2 col-md-2 col-12">
                    ...
                    <div class="logo">
                        @php
                            $settings=DB::table('settings')->get();
                        @endphp                    
                        <a href="{{route('home')}}"><img style="height: 50px;" src="@foreach($settings as $data) {{$data->logo}} @endforeach" alt="logo"></a>
                    </div>
                    <!--/ End Logo -->
                    <!-- Search Form -->
