...
<section class="shop checkout section">
    <div class="container">
        <form onsubmit="return validateShippingCalculation();" class="form" method="POST" action="{{route('cart.order')}}">
            @csrf
            <div class="row">
                            ...
                            <div class="content">
                                <ul>
                                    ...
                                    <li class="shipping_cost">
                                        ...
                                        <!-- Ongkir section -->
                                        <span id="shipping_cost">Rp0.00</span>
                                    </li>
                                    @else
                                    <span>Free</span>
                                    @endif
                                    ...
                                    <li>
                                        @csrf
                                        <div class="form-group">
                                            <input type="text" id="delivery_address" placeholder="Input Your Address" required>
                                        </div>
                                        <div class="single-widget get-button">
                                            <div class="button">
                                                <button class="btn" type="button" onclick="calculateShipping()">Check Shipping Cost</button>
                                            </div>
                                        </div>
                                    </li>
                                    @php
...
<script>
    ...
    function calculateShipping() {
        ...
        if (address) {
            fetch(`https://api.positionstack.com/v1/forward?access_key=ec92772e33ac613f565e5c4d09e4b447&query=${address}`)
                ...
                .then(data => {
                    if (data && data.data && data.data.length > 0) {
                        ...
                        if (distance > 10) {
                            shippingCost = (distance * 2).toFixed(2);
                        }
                        else
                        {
                        ...
                        $('#shipping_cost').text(`Rp${shippingCost}`);
                        ...
                        $('#order_total_price').text(`Rp${total}`);
    ...
    function validateShippingCalculation() {
        if (!isShippingCalculated) {
            alert("Please fill your address and click button to check your shipping cost");
            return false;
        }
        return true;
    }
