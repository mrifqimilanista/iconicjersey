...
Route::post('/add-to-cart', [CartController::class, 'singleAddToCart'])
...
})->name('cart')->middleware(User::class);
Route::get('/checkout', [CartController::class, 'checkout'])->name('checkout')->middleware(User::class);

// Wishlist
Route::get('/wishlist', function() {
    return view('frontend.pages.wishlist');
})->name('wishlist');
Route::get('/wishlist/{slug}', [WishlistController::class, 'wishlist'])->name('add-to-wishlist')->middleware(User::class);
...
Route::group(['prefix'=>'/admin','middleware'=>[Authenticate::class, Admin::class]],function(){
...
// User section start
Route::group(['prefix'=>'/user', User::class], function(){
